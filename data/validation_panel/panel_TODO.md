...
| `citreoviridin_suh_imda_1985/` | transannular_diels_alder | n/a | **SLOT UNFILLABLE AS NAMED — Ivan must decide on substitution.** Replacement scaffolded at `phoenix_reddy_cassaine_tda_2008/` per the recommendation in the citreoviridin diagnosis. Decide: drop this slot or keep it as a deferred chemistry-error record. |
